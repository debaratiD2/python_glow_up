...
| :---: | :---- |
| **while**  | When the number of iterations is **unknown** <br>depends on a **condition** (e.g., user input, until a flag is set) |
| **for** | When **you know exactly how many times to iterate** <br>(e.g., **over a list, a fixed range**) |
